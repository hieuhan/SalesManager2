...
namespace SalesManagerLib
{
    public sealed class Logger
    {
        ...
        public static void Start()
        {
            ...
            TargetLogFile = new FileInfo(string.Concat(HttpContext.Current.Request.PhysicalApplicationPath, "\\Logs\\Log", currentDateTime.ToString("ddMMyyyyHHmmss"), LogExtension));
    ...
    public sealed class LogMessageInfo : EventArgs
    {
        ...
        public bool IsError { get { return SalesManagerLib.Logger.ERROR.Equals(Level, StringComparison.Ordinal); } }
        public bool IsWarning { get { return SalesManagerLib.Logger.WARN.Equals(Level, StringComparison.Ordinal); } }
        public bool IsInformation { get { return SalesManagerLib.Logger.INFO.Equals(Level, StringComparison.Ordinal); } }
        public bool IsDebug { get { return SalesManagerLib.Logger.DEBUG.Equals(Level, StringComparison.Ordinal); } }
        ...
        public override string ToString()
        {
            ...
            loglineStringBuilder.Append(Timestamp.ToString("dd/MM/yyyy HH:mm:ss.fff"));
            loglineStringBuilder.Append(System.Environment.NewLine);

            loglineStringBuilder.Append("ThreadId : ");
            loglineStringBuilder.Append(ThreadId);
            loglineStringBuilder.Append(System.Environment.NewLine);

            loglineStringBuilder.Append("Logger : ");
            loglineStringBuilder.Append(Logger);
            loglineStringBuilder.Append(System.Environment.NewLine);

            loglineStringBuilder.Append("Level : ");
            loglineStringBuilder.Append(Level);
            loglineStringBuilder.Append(System.Environment.NewLine);
            ...
            loglineStringBuilder.AppendFormat("Message:\t{0}", Message);
            loglineStringBuilder.Append(System.Environment.NewLine);
            ...
            //return string.Format("{0:dd/MM/yyyy HH:mm:ss.fff} \t ThreadId: {1} \t Logger: {2} \t Level: {3} \t Message: {4}",
